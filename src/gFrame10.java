 ...
 * @author Hawk
 */
public class gFrame10 extends javax.swing.JFrame {
User user;
Game game;
    /**
     * Creates new form gFrame10
     */
    public gFrame10(User user) {
        initComponents();
        this.user=user;
        GameSto gt = new GameSto();
        game = gt.getGame("Death Stranding");
    ...
    private void initComponents() {
        ...
        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/DS box art.jpg"))); // NOI18N
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Death Stranding.jpg"))); // NOI18N
        jPanel2.add(jLabel1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(gFrame10.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
