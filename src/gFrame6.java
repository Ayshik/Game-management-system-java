 ...
 * @author Hawk
 */
public class gFrame6 extends javax.swing.JFrame {
User user;
Game game;
    /**
     * Creates new form gFrame6
     */
    public gFrame6(User user) {
        initComponents();
        this.user=user;
        GameSto gt = new GameSto();
        game = gt.getGame("Red Dead Redemption 2");
    ...
    private void initComponents() {
        ...
        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/rdr 2 box.jpg"))); // NOI18N
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/rdr 2.jpg"))); // NOI18N
        jPanel2.add(jLabel1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(gFrame6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
