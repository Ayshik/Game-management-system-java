 ...
 * @author Hawk
 */
public class gFrame2 extends javax.swing.JFrame {
User user;
Game game;
    /**
     * Creates new form gFrame2
     */
    public gFrame2(User user) {
        initComponents();
        this.user=user;
         GameSto gt = new GameSto();
        game = gt.getGame("Fallout 4");
    ...
    private void initComponents() {
        ...
        AddToCart.setBounds(460, 320, 100, 23);
        ...
        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Fallout 4 Box Art.jpg"))); // NOI18N
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Fallout 4.jpg"))); // NOI18N
        jPanel2.add(jLabel1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(gFrame2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
