 ...
 * @author Hawk
 */
public class gFrame3 extends javax.swing.JFrame {
User user;
Game game;
    /**
     * Creates new form gFrame3
     */
    public gFrame3(User user) {
        initComponents();
        this.user=user;
        GameSto gt = new GameSto();
        game = gt.getGame("FIFA 20");
    ...
    private void initComponents() {
        ...
        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/fifa20 box.jpg"))); // NOI18N
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/FIFA 20.jpg"))); // NOI18N
        jPanel2.add(jLabel1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(gFrame3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
