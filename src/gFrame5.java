 ...
 * @author Hawk
 */
public class gFrame5 extends javax.swing.JFrame {
User user;
Game game;
    /**
     * Creates new form gFrame5
     */
    public gFrame5(User user) {
        initComponents();
        this.user=user;
        GameSto gt = new GameSto();
        game = gt.getGame("Need For Speed: Heat");
    ...
    private void initComponents() {
        ...
        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/nfsf heat box.jpg"))); // NOI18N
        ...
        jPanel2.add(jLabel6);
        jLabel6.setBounds(370, 170, 120, 20);

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Platform :");
        jPanel2.add(jLabel5);
        jLabel5.setBounds(370, 130, 100, 20);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/NFS Heat.jpg"))); // NOI18N
        jPanel2.add(jLabel1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(gFrame5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
