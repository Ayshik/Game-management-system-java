 ...
 * @author Hawk
 */
public class gFrame9 extends javax.swing.JFrame {
User user;
Game game;
    /**
     * Creates new form gFrame9
     */
    public gFrame9(User user) {
        initComponents();
        this.user=user;
        GameSto gt = new GameSto();
        game = gt.getGame("The Witcher 3: Wild Hunt");
    ...
    private void initComponents() {
        ...
        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/witcher 3 box.jpg"))); // NOI18N
        ...
        jPanel2.add(jLabel3);
        jLabel3.setBounds(370, 90, 100, 20);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Witcher 3 (2).jpg"))); // NOI18N
        jPanel2.add(jLabel1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(gFrame9.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
